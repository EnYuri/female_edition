/**
 * Type-only stub for `src/applications/settings/world-settings/WorldSettings.types`.
 *
...
export type DefaultTabSelectionFields = any;
export type WorldSettingsContext = any;
export type WorldSettingsFunctions = any;
