/**
 * Type-only stub for `src/components/button-menu/button-menu-types`.
 *
...
export type ButtonMenuAnchor = any;
export type ButtonMenuContext = any;
export type ButtonMenuPosition = any;
export type ButtonMenuPositionStyleInPixels = any;
