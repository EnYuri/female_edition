...
// `GroupBastionsTab` survives only inside a commented-out tab registration below, so it
// was tree-shaken out of upstream's build and is absent from the published sourcemap.
