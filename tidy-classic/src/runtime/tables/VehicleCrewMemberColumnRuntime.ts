...
// `DraftAnimalTestColumn` was imported here for a "Sample Column" spec that was declared
// and never referenced. Being unused, it was tree-shaken out of upstream's build, so the
// component is absent from the published sourcemap and cannot be recovered — and does not
// need to be, since nothing consumed it.
