/**
 * Type-only stub for `src/migrations/migration-selection/migration-selection.types`.
 *
...
export type MigrationSelectionParams = any;
export type SelectableMigrationSelectionParams = any;
