...
export class Tidy5eNpcSheetQuadrone extends Tidy5eActorSheetQuadroneBase<NpcSheetQuadroneContext>(
  ...
  protected _prepareSpellcastingContext(
    ...
    const msak = dnd5e.utils.simplifyBonus(
      getActorAttackBonus(this.actor, 'msak'),
      rollData
    );
    const rsak = dnd5e.utils.simplifyBonus(
      getActorAttackBonus(this.actor, 'rsak'),
      rollData
    );
