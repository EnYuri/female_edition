# Tidy 5e Sheets — Classic layout

This directory contains a maintained fork of **Tidy 5e Sheets v12.5.5** by
**kgar**, the last upstream release to include the Classic layout:
...
`public/rpg-awesome/` contains the unmodified RPG-Awesome icon font by Daniela
Howe and Ivan Montiel. See `public/rpg-awesome/LICENSE.md`.
